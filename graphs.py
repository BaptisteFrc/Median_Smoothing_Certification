...
def graph_diff(f : FunctionType, n : int, G : FunctionType, p : float) ->None:
    """
    only works for d=1
    """
...
def graph_and_bounds(f : FunctionType, n : int, sigma : float, p : float, alpha : float, epsilon : float) ->None:
...
def graph_and_bounds_exp(f : FunctionType, n : int, sigma : float, l : float, u : float, alpha : float, epsilon : float):
...
def max_graph(f : FunctionType, n : int, sigma : float, p : float, alpha : float, epsilon : float, precision : float):
